...
def write_index_step2(findex, data):
   findex.write('''
	...
	<div class="container">
      ...
      GitHub project</a>. The website contains all siggraph 2014, 2016 and 2018 papers. We are collecting contributions for other venues but we are not yet exhaustive for them.</p>
